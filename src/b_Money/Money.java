...
public class Money implements Comparable {
    ...
    public Money add(Money other) {
        int amt = (int) (amount + other.amount / currency.getRate());
    ...
    public int compareTo(Object other) {
        if (universalValue().equals(((Money) other).universalValue())) {
            return 0;
        } else {
            return (universalValue() < ((Money) other).universalValue()) ? -1 : 1;
        }
    }
}