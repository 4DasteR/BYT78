...
public class Account {
	...
	public void addTimedPayment(String id, Integer interval, Integer next, Money amount, Bank tobank, String toaccount) {
		/*
		Original testing (AccountTest.testAddRemoveTimedPayment) resulted in NullPointerException being thrown.
		It is directly caused by issues with Bank.deposit method, due to the fact that AccountTest.setUp uses that method to give a new account some money.
		For more detailed description please see Bank.deposit method, where I explained all issues with it.
		 */
	...
	public boolean timedPaymentExists(String id) {
		/*
		Original testing (AccountTest.testTimedPayment) resulted in NullPointerException being thrown.
		It is directly caused by issues with Bank.deposit method, due to the fact that AccountTest.setUp uses that method to give a new account some money.
		For more detailed description please see Bank.deposit method, where I explained all issues with it.
		 */
	...
	public void deposit(Money money) {
		/*
		Original testing (AccountTest.testAddWithdraw) resulted in NullPointerException being thrown.
		It is directly caused by issues with Bank.deposit method, due to the fact that AccountTest.setUp uses that method to give a new account some money.
		For more detailed description please see Bank.deposit method, where I explained all issues with it.
		 */
